...

{
    ...
    public function onRun()
    {
      ...
      foreach ($allCarModel as $key => $value) {
        ...
        $caraccessories_prices[] = "<100";
        $caraccessories_prices[] = "300-500";
        $caraccessories_prices[] = "501-1000";
        $caraccessories_prices[] = "1000++";
        ...
        $this->page['caraccessories_pricelist'] = $caraccessories_prices;
